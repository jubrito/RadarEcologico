...
> = {
  favorable: {
    ...
    cardBg: "border-emerald-600/30 bg-emerald-950/30",
  ...
  needs_review: {
    ...
    cardBg: "border-amber-500/30 bg-amber-950/30",
  ...
  unfavorable: {
    ...
    cardBg: "border-red-600/30 bg-red-950/30",
  ...
  unknown: {
    ...
    cardBg: "border-gray-500/30 bg-gray-950/30",
